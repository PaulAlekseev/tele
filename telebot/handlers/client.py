...
def register_handlers_client(dp: Dispatcher):
    ...
    dp.register_message_handler(create_activation, lambda c: c.data in activation_text)
    dp.register_callback_query_handler(create_activation, lambda message: message.text in activation_text)
